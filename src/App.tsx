...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2b292e] via-[#3a353c] to-[#50424d] text-[var(--mist)] font-['Hack']">
          ...
          <section ref={heroRef} className="relative flex flex-col items-center justify-center min-h-[70vh] mb-16">
            ...
            <div className="relative z-10 text-center w-full">
              ...
              <div className="mt-10 scale-in" style={{animationDelay: '0.4s'}}>
                ...
                <div className="scroll-cards-container px-2 md:px-4">
      ...
      {/* Tab Navigation at the Bottom with enhanced styling */}
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-[rgba(43,41,45,0.85)] backdrop-blur-md border-t border-[rgba(255,255,255,0.12)] py-2 md:hidden">
        <div className="flex justify-around px-2">
          <button 
            onClick={() => setActiveTab('home')}
            className={`p-2 rounded-lg ${activeTab === 'home' ? 'bg-[rgba(255,160,122,0.15)]' : ''} transition-all duration-300`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={activeTab === 'home' ? 'text-[var(--ac-primary)]' : 'text-[var(--mist)]'}>
          ...
          <button 
            onClick={() => setActiveTab('what-we-do')}
            className={`p-2 rounded-lg ${activeTab === 'what-we-do' ? 'bg-[rgba(255,160,122,0.15)]' : ''} transition-all duration-300`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={activeTab === 'what-we-do' ? 'text-[var(--ac-primary)]' : 'text-[var(--mist)]'}>
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
            </svg>
          </button>
          <button 
            onClick={() => setActiveTab('team')}
            className={`p-2 rounded-lg ${activeTab === 'team' ? 'bg-[rgba(255,160,122,0.15)]' : ''} transition-all duration-300`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={activeTab === 'team' ? 'text-[var(--ac-primary)]' : 'text-[var(--mist)]'}>
          ...
          <button 
            onClick={() => setActiveTab('tech')}
            className={`p-2 rounded-lg ${activeTab === 'tech' ? 'bg-[rgba(255,160,122,0.15)]' : ''} transition-all duration-300`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={activeTab === 'tech' ? 'text-[var(--ac-primary)]' : 'text-[var(--mist)]'}>
              <path d="M18 10h-4V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v4a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2z"></path>
            </svg>
          </button>
          <button 
            onClick={() => setActiveTab('contact')}
            className={`p-2 rounded-lg ${activeTab === 'contact' ? 'bg-[rgba(255,160,122,0.15)]' : ''} transition-all duration-300`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={activeTab === 'contact' ? 'text-[var(--ac-primary)]' : 'text-[var(--mist)]'}>
