          ...
          <div className="relative">
            ...
            <div className="relative glass-card">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Backend Development */}
                <motion.div variants={itemVariants} className="glass-item group p-8 relative overflow-hidden">
              ...
              >
                <Link 
                  to="/#contact" 
                  className="px-8 py-4 rounded-full glass-button text-[var(--ac-primary)] transition-all inline-flex items-center"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  <div className="relative w-16 h-16 mx-auto mb-4 flex items-center justify-center bg-[rgba(255,160,122,0.15)] rounded-full">
                    ...
                    <div className="absolute inset-0 bg-[var(--ac-primary)] opacity-10 rounded-full animate-pulse"></div>
                  </div>
                ...
                >
                  <div className="relative w-16 h-16 mx-auto mb-4 flex items-center justify-center bg-[rgba(245,215,110,0.15)] rounded-full">
                    ...
                    <div className="absolute inset-0 bg-[var(--accent-honey)] opacity-10 rounded-full animate-pulse"></div>
                  </div>
                ...
                >
                  <div className="relative w-16 h-16 mx-auto mb-4 flex items-center justify-center bg-[rgba(230,107,117,0.15)] rounded-full">
                    ...
                    <div className="absolute inset-0 bg-[var(--accent-ember)] opacity-10 rounded-full animate-pulse"></div>
                  </div>
