...
export default function People({ people, onProfileView }: PeopleProps) {
  ...
  const handleGitHubClick = (e: React.MouseEvent, github: string) => {
    ...
    setTimeout(() => target.classList.remove('animate-click'), 300);
            ...
            <div className="md:w-1/3 flex flex-col items-center md:items-start mb-6 md:mb-0 fade-in" style={{ opacity: 0, animationDelay: '0.1s' }}>
              ...
              {selectedPerson.github && (
                <button
                  ...
                  className="mt-6 px-4 py-2 rounded-full glass-button text-[var(--ac-primary)] transition-all inline-flex items-center shimmer-effect fade-in"
